...
function registerMessageHandler(bot) {
    bot.on("message", async (msg) => {
        ...
        if (userText === "✏️ Savolim bor") {
            ...
            await bot.sendMessage(chatId, "✍️ Savolingizni yozing. Endi men bilan doimiy muloqot qilishingiz mumkin (chiqish uchun Bosh menyuni bosing):", { reply_markup: buildKeyboard("root") });
            return;
        }
